...
INSERT INTO `__new_application`("id", "userId", "applicationNumber", "schoolSessionId", "status", "isComplete", "isSubmitted", "firstName", "middleName", "otherNames", "lastName", "phoneNumber", "birthDay", "birthMonth", "birthYear", "gender", "stateOfOrigin", "lga", "nationality", "nin", "firstParentName", "firstParentAddress", "firstParentStatus", "secondParentName", "secondParentAddress", "secondParentStatus", "nextOfKinName", "nextOfKinAddress", "nextOfKinRelationship", "nextOfKinPhoneNumber", "course", "degreeType", "jambRegNumber", "secondarySchoolName", "secondarySchoolGraduationMonth", "secondarySchoolGraduationYear", "passportUrl", "birthCirtificateUrl", "stateOfOriginUrl", "oLevelResultUrl", "postUTMESlipUrl", "admissionFormPaymentReceiptUrl", "createdAt", "updatedAt") SELECT "id", "userId", "applicationNumber", "schoolSessionId", "status", "isComplete", "isSubmitted", "firstName", "middleName", "otherNames", "lastName", "phoneNumber", "birthDay", "birthMonth", "birthYear", "gender", "stateOfOrigin", "lga", "nationality", "nin", "firstParentName", "firstParentAddress", "firstParentStatus", "secondParentName", "secondParentAddress", "secondParentStatus", "nextOfKinName", "nextOfKinAddress", "nextOfKinRelationship", "nextOfKinPhoneNumber", "course", "degreeType", "jambRegNumber", "secondarySchoolName", "secondarySchoolGraduationMonth", "secondarySchoolGraduationYear", "passportUrl", "birthCirtificateUrl", "stateOfOriginUrl", "oLevelResultUrl", "postUTMESlipUrl", "admissionFormPaymentReceiptUrl", "createdAt", "updatedAt" FROM `application`;--> statement-breakpoint
...
CREATE UNIQUE INDEX `application_user_session_unique` ON `application` (`userId`,`schoolSessionId`);