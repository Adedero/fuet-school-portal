...
INSERT INTO `__new_application`("id", "userId", "applicationNumber", "schoolSessionId", "status", "firstName", "middleName", "otherNames", "lastName", "phoneNumber", "birthDay", "birthMonth", "birthYear", "gender", "stateOfOrigin", "lga", "nationality", "nin", "firstParentName", "firstParentAddress", "firstParentStatus", "secondParentName", "secondParentAddress", "secondParentStatus", "nextOfKinName", "nextOfKinAddress", "nextOfKinRelationship", "nextOfKinPhoneNumber", "course", "degreeType", "jambRegNumber", "secondarySchoolName", "secondarySchoolAddress", "secondarySchoolGraduationMonth", "secondarySchoolGraduationYear", "passportUrl", "birthCirtificateUrl", "stateOfOriginUrl", "oLevelResultUrl", "postUTMESlipUrl", "admissionFormPaymentReceiptUrl", "createdAt", "updatedAt") SELECT "id", "userId", "applicationNumber", "schoolSessionId", "status", "firstName", "middleName", "otherNames", "lastName", "phoneNumber", "birthDay", "birthMonth", "birthYear", "gender", "stateOfOrigin", "lga", "nationality", "nin", "firstParentName", "firstParentAddress", "firstParentStatus", "secondParentName", "secondParentAddress", "secondParentStatus", "nextOfKinName", "nextOfKinAddress", "nextOfKinRelationship", "nextOfKinPhoneNumber", "course", "degreeType", "jambRegNumber", "secondarySchoolName", "secondarySchoolAddress", "secondarySchoolGraduationMonth", "secondarySchoolGraduationYear", "passportUrl", "birthCirtificateUrl", "stateOfOriginUrl", "oLevelResultUrl", "postUTMESlipUrl", "admissionFormPaymentReceiptUrl", "createdAt", "updatedAt" FROM `application`;--> statement-breakpoint
