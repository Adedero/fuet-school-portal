    ...
    <section id="about-fuet">
      ...
      >
        <div class="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p class="text-lg text-gray-600 max-w-2xl mx-auto">
            Learn about the Federal University of Environment and Technology,
      ...
      >
        <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
          <div
            class="bg-white p-8 border rounded-2xl shadow-md hover:shadow-xl transition"
          >
            <h2
              class="flex items-center gap-2 text-2xl font-bold text-primary-600 mb-4"
            >
      ...
      >
        <div class="max-w-3xl mx-auto">
          <div
            class="bg-white rounded-2xl shadow-xl p-8 flex flex-col md:flex-row items-center gap-8 border border-green-100"
          >
            <div
              class="flex-shrink-0 w-32 h-32 rounded-full overflow-hidden border-4 border-primary-500 bg-gray-100 flex items-center justify-center"
            >
              <img
                src="/images/Professor-Prince-Chinedu-Mmom-JP-DSSRS.webp"
                alt="Vice Chancellor"
                class="w-full h-full object-cover"
                @error="(e) => (e.target as HTMLImageElement).src = 'https://placehold.co/128x128?text=VC'"
              />
            </div>
            <div class="flex-1 text-center md:text-left space-y-3">
              <h2
                class="text-2xl font-bold text-primary-600 flex items-center gap-2 justify-center md:justify-start"
              >
                <User class="w-7 h-7 text-primary-500" /> Vice Chancellor's
                Welcome Note
              </h2>
