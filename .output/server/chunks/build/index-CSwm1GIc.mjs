import { b as _sfc_main$a, d as _sfc_main$4, c as _sfc_main$g } from './server.mjs';
import { _ as __nuxt_component_1 } from './fetch-error-alert-B6qqzpgU.mjs';
import { defineComponent, withAsyncContext, ref, mergeProps, unref, isRef, withCtx, createVNode, createTextVNode, toDisplayString, createBlock, openBlock, useSSRContext } from 'vue';
...
import { _ as _sfc_main$3 } from './Card-Bv7yDMxb.mjs';
import { _ as _sfc_main$5 } from './Badge-BP5AIZVh.mjs';
import { _ as __nuxt_component_6 } from './deleter-BJt07ff6.mjs';
import { useDateFormat } from '@vueuse/core';
import { _ as __nuxt_component_5 } from './initiation-form-Fm6AwWTT.mjs';
...
import './Input-qaklspGC.mjs';
import './Select-Bdo7U_Ov.mjs';
import './password-D7_aCKk5.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ApplicationDeleter = __nuxt_component_6;
      _push(ssrRenderComponent(_component_NuxtCard, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div${_scopeId}><div${_scopeId}><p class="text-sm mb-2"${_scopeId}>${ssrInterpolate(_ctx.application.course ?? "unknown course")}, <b${_scopeId}>${ssrInterpolate(_ctx.application.degreeType ?? "unknown degree")}</b></p><h4 class="font-mono text-2xl font-semibold"${_scopeId}>${ssrInterpolate(_ctx.application.applicationNumber)}</h4><p class="font-mono"${_scopeId}> Session: ${ssrInterpolate(_ctx.application.schoolSession?.name ?? "Unknown Session")}</p>`);
            _push2(ssrRenderComponent(_component_NuxtBadge, {
              label: _ctx.application.status === "pending" || _ctx.application.status === "submitted" ? _ctx.application.status : "application processed",
              color: _ctx.application.status === "pending" ? "success" : "error",
              variant: "subtle"
            ...
            if (_ctx.application.status !== "pending") {
            ...
            _push2(ssrRenderComponent(_component_ApplicationDeleter, {
              "application-id": _ctx.application.id,
              onRemove: (id) => emit("remove", id)
            }, {
              default: withCtx(({ loading }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            return [
              createVNode("div", null, [
                createVNode("div", null, [
                  ...
                  createVNode("h4", { class: "font-mono text-2xl font-semibold" }, toDisplayString(_ctx.application.applicationNumber), 1),
                  createVNode("p", { class: "font-mono" }, " Session: " + toDisplayString(_ctx.application.schoolSession?.name ?? "Unknown Session"), 1),
                ...
                createVNode("div", { class: "text-sm mt-2.5 space-y-5" }, [
                  createVNode("div", { class: "flex items-center justify-between gap-2.5" }, [
                    ...
                    createVNode("div", { class: "flex items-center gap-2.5" }, [
                      _ctx.application.status !== "pending" ? (openBlock(), createBlock(_component_NuxtButton, {
                        key: 0,
                        to: `/application/portal/${_ctx.application.id}`,
                        size: "sm",
                        label: "Review",
                        icon: "lucide:view"
                      }, null, 8, ["to"])) : (openBlock(), createBlock(_component_NuxtButton, {
                        key: 1,
                        to: `/application/portal/${_ctx.application.id}`,
                        size: "sm",
                        label: "Edit",
                      ...
                      createVNode(_component_ApplicationDeleter, {
                        "application-id": _ctx.application.id,
                        onRemove: (id) => emit("remove", id)
                      }, {
...
//# sourceMappingURL=index-CSwm1GIc.mjs.map
