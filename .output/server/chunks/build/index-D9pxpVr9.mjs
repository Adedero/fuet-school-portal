...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const AcademicOverview = defineAsyncComponent(() => import('./academic-overview-ckQaPoXv.mjs'));
    const QuickActions = defineAsyncComponent(() => import('./quick-actions-DwW5ajAZ.mjs'));
    const RecentGrades = defineAsyncComponent(() => import('./recent-grades-BM_qSWM3.mjs'));
    const UpcomingDeadlines = defineAsyncComponent(() => import('./upcoming-deadlines-D5WTP6Xj.mjs'));
    const AcademicProgress = defineAsyncComponent(() => import('./academic-progress-B7Dc_KbS.mjs'));
...
//# sourceMappingURL=index-D9pxpVr9.mjs.map
