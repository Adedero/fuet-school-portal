...
import { _ as _sfc_main$1$1, a as _sfc_main$5 } from './FormField-D2Q403g3.mjs';
import { _ as _sfc_main$6 } from './SelectMenu-Da07R2ba.mjs';
...
import { b as _sfc_main$a, h as useToast, V as useConfirm, e as _sfc_main$g, k as useAppConfig, z as useLocale, l as useFormField, t as tv, o as _sfc_main$d } from './server.mjs';
import { a8 as normalizeException, N as formatBytes } from '../nitro/nitro.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtButton = _sfc_main$a;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full" }, _attrs))}><div class="lg:max-w-[70%] mx-auto"><header><h1 class="text-xl font-bold">Documents</h1><p class="text-sm muted"> Please upload the required documents to complete your application. </p></header><section class="my-5">`);
      if (unref(error)) {
        _push(`<div>`);
...
//# sourceMappingURL=index-UxAOGK7q.mjs.map
