...
import { _ as _sfc_main$2 } from './DropdownMenu-o0skE-nA.mjs';
import { b as _sfc_main$a, S as __nuxt_component_2 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "md:flex md:h-[calc(100dvh-4rem)]" }, _attrs))}><nav class="hidden md:block md:w-72 border-r border-r-default p-2.5">`);
...
//# sourceMappingURL=index-CouH9Qbv.mjs.map
