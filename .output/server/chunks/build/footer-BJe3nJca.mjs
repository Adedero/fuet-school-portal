import { l as useConfirm, k as useRuntimeConfig, a as __nuxt_component_0$1, b as _sfc_main$a, i as authClient, n as navigateTo } from './server.mjs';
import { u as useAuth, _ as __nuxt_component_2$1 } from './use-auth-CVG_VBvu.mjs';
...
import { _ as _sfc_main$2 } from './Separator-DbfvDEeu.mjs';
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div${_scopeId}><p class="font-extrabold text-lg"${_scopeId}><span class="text-primary-500"${_scopeId}>${ssrInterpolate(unref(appName).val1)}</span></p><p class="text-muted text-sm hidden md:block"${_scopeId}> Koroma/Saakpenwa, Ogoni </p></div>`);
          } else {
            return [
              createVNode(_component_AppLogo, { width: 45 }),
              createVNode("div", null, [
                createVNode("p", { class: "font-extrabold text-lg" }, [
...
//# sourceMappingURL=footer-BJe3nJca.mjs.map
