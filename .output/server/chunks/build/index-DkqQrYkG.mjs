import { defineComponent, withAsyncContext, mergeProps, withCtx, createVNode, unref, useSlots, computed, toRef, resolveDynamicComponent, renderSlot, createBlock, createCommentVNode, openBlock, createTextVNode, toDisplayString, withModifiers, Fragment, renderList, toHandlers, useSSRContext } from 'vue';
...
import { V as normalizeException, D as defu } from '../_/nitro.mjs';
import { reactivePick, createReusableTemplate } from '@vueuse/core';
import { b as _sfc_main$a, w as __nuxt_component_1, e as useAppConfig, t as tv, o as isArrayOfArray, p as _sfc_main$d, c as _sfc_main$g, q as get, r as _sfc_main$b, s as pickLinkProps, v as _sfc_main$c, m as usePortal } from './server.mjs';
import { _ as _sfc_main$5 } from './Badge-C-trVj-1.mjs';
import { HoverCard, Popover } from 'reka-ui/namespaced';
import { _ as _sfc_main$4, a as _sfc_main$2$1 } from './DropdownMenu-D-PSeQp3.mjs';
                        ...
                        ssrRenderSlot(_ctx.$slots, "content", {}, () => {
                          ...
                          if (__props.kbds?.length) {
                            ...
                            ssrRenderList(__props.kbds, (kbd, index) => {
                              _push4(ssrRenderComponent(_sfc_main$2$1, mergeProps({
                                key: index,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtDropdownMenu = _sfc_main$4;
      const _component_NuxtButton = _sfc_main$a;
      const _component_FetchErrorAlert = __nuxt_component_0;
      const _component_NuxtPage = __nuxt_component_1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "md:flex h-[calc(100dvh-3.5rem)]" }, _attrs))}><nav class="hidden md:block border-r border-r-default p-2.5">`);
      _push(ssrRenderComponent(_component_NuxtNavigationMenu, {
        items,
        orientation: "vertical"
      }, null, _parent));
      _push(`</nav><div class="grow"><div class="md:hidden px-5 py-2.5">`);
...
//# sourceMappingURL=index-DkqQrYkG.mjs.map
