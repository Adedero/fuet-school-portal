...
import { _ as __nuxt_component_5 } from './initiation-form-CBDtL943.mjs';
      ...
      _push(ssrRenderComponent(_component_NuxtCard, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (!_ctx.application.hasPaidAdmissionFee) {
                ...
                createVNode("div", { class: "text-sm mt-2.5 space-y-5" }, [
                  createVNode("div", { class: "flex items-center justify-between gap-2.5" }, [
                    ...
                    createVNode("div", { class: "flex items-center gap-2.5" }, [
                      ...
                      !_ctx.application.hasPaidAdmissionFee ? (openBlock(), createBlock(_component_ApplicationDeleter, {
                        key: 2,
                        "application-id": _ctx.application.id,
                        onRemove: (id) => emit("remove", id)
                      }, {
                        ...
                        _: 1
                      }, 8, ["application-id", "onRemove"])) : createCommentVNode("", true)
                    ])
                  ])
                ])
              ])
...
//# sourceMappingURL=index-Bapny-KM.mjs.map
