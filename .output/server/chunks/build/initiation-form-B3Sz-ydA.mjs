...
import { _ as _sfc_main$3 } from './Input-B12ViNMG.mjs';
import { _ as _sfc_main$4 } from './Select-C4S5T0cF.mjs';
import { _ as __nuxt_component_3 } from './password-DjXQGO_M.mjs';
import { h as useToast, b as _sfc_main$a, n as navigateTo } from './server.mjs';
import { defineComponent, reactive, mergeProps, unref, withCtx, createVNode, createBlock, createCommentVNode, openBlock, useSSRContext } from 'vue';
...
import { Y as MIN_AGE, X as normalizeException } from '../nitro/nitro.mjs';
      ...
      _push(ssrRenderComponent(_component_NuxtForm, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_NuxtInput, {
                    ...
                    disabled: !!unref(authStore).user.value,
                    size: "lg",
                    class: "w-full"
                  }, null, _parent3, _scopeId2));
                } else {
            ...
            _push2(`</div><div class="flex justify-end gap-2.5 mt-5"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "grid md:grid-cols-2 gap-2.5" }, [
                ...
                !unref(authStore).user.value ? (openBlock(), createBlock(_component_NuxtFormField, {
                  key: 0,
                  name: "password",
                  label: "Password",
                  required: ""
              ...
              createVNode("div", { class: "flex justify-end gap-2.5 mt-5" }, [
...
//# sourceMappingURL=initiation-form-B3Sz-ydA.mjs.map
