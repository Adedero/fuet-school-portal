...
import { b as _sfc_main$a, c as _sfc_main$g, d as _sfc_main$4 } from './server.mjs';
import { _ as _sfc_main$1 } from './Card-CY-sinbI.mjs';
import { _ as __nuxt_component_5 } from './initiation-form-DfIZ2X-K.mjs';
...
import { u as useFetch } from './fetch-Uqn8ZqjD.mjs';
...
import 'ipx';
import 'node:path';
import './Input-AILfbvl_.mjs';
import './Select-D7_9cF2t.mjs';
import './password-_r7EbA7R.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(error)) {
        ...
        if (!unref(data).applicationsOpen) {
          _push(`<div class="min-h-dvh md:min-h-[60dvh] flex-col-center gap-5"><h1 class="text-center text-2xl md:text-3xl lg:text-4xl font-semibold text-red-500"> Application Closed! </h1><p class="text-muted max-w-96 text-center"> Applications for the 2024/2025 academic session are currently closed. </p><div class="flex-col-center gap-1 text-center"><p class="font-bold">Application dates</p><p><span>${ssrInterpolate(unref(useDateFormat)(
          ...
          _push(ssrRenderComponent(_component_NuxtCard, null, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(`</div><p class="text-2xl font-semibold"${_scopeId}><span class="text-primary"${_scopeId}>New</span> Application </p><p class="text-sm text-muted"${_scopeId}> Applications for the 2024/2025 academic session are now open. </p>`);
                ...
                return [
                  createVNode("div", { class: "flex-col-center gap-2 text-center" }, [
                    ...
                    createVNode("p", { class: "text-sm text-muted" }, " Applications for the 2024/2025 academic session are now open. "),
          ...
          _push(ssrRenderComponent(_component_NuxtCard, null, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(`</div><p class="text-2xl font-semibold"${_scopeId}><span class="text-primary"${_scopeId}>Existing</span> Application </p><p class="text-sm text-muted"${_scopeId}> Applications for the 2024/2025 academic session are now open. </p>`);
...
//# sourceMappingURL=index-DgSkHDBu.mjs.map
