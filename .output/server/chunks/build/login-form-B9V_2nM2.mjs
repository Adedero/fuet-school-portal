...
import { _ as _sfc_main$1 } from './Checkbox-6ddTYado.mjs';
import { _ as _sfc_main$2 } from './Separator-Cxtlj3w1.mjs';
import { _ as _sfc_main$1$1, a as _sfc_main$3 } from './FormField-D2Q403g3.mjs';
import { _ as _sfc_main$4 } from './Input-BL7KxnW2.mjs';
import { _ as __nuxt_component_3 } from './password-CqqvzGsv.mjs';
import { g as useRoute, h as useToast, a as __nuxt_component_0, b as _sfc_main$a, i as authClient, j as createError, d as useRuntimeConfig, n as navigateTo } from './server.mjs';
import { defineComponent, ref, reactive, unref, isRef, withCtx, createVNode, createTextVNode, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isLoggingInToApplicationPortal = ref(false);
    ...
    async function onSubmit(event) {
      error.value = null;
      const submittedEmail = event.data.email;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtCheckbox, {
        modelValue: unref(isLoggingInToApplicationPortal),
        "onUpdate:modelValue": ($event) => isRef(isLoggingInToApplicationPortal) ? isLoggingInToApplicationPortal.value = $event : null,
...
//# sourceMappingURL=login-form-B9V_2nM2.mjs.map
