...
import { b as _sfc_main$a, T as useNuxtApp, U as injectHead$1, d as useRuntimeConfig } from './server.mjs';
import { defineComponent, mergeProps, withCtx, createVNode, toDisplayString, reactive, getCurrentInstance, onMounted, isRef, watch, onScopeDispose, ref, hasInjectionContext, inject, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_AppSettings, null, {
...
//# sourceMappingURL=index-DBBQhKzx.mjs.map
