import { d as defineEventHandler, k as getValidatedQuery, c as createError, b as db } from '../../../../nitro/nitro.mjs';
  ...
  const applications = await db.query.application.findMany({
    where: (app, { and, eq }) => {
      return and(
        ...
        typeof hasPaidAdmissionFees !== "undefined" ? eq(app.hasPaidAdmissionFees, hasPaidAdmissionFees) : void 0
      );
    },
    limit,
    offset
